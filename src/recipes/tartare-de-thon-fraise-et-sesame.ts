...
export const tartareDeThonFraiseEtSesame: Recipe = {
  ...
  description:
    'Un tartare frais et parfumé associant le thon, la fraise et le sésame, idéal pour une entrée légère.',
  categories: ['Entrées'],
  ...
  images: [
    {
      small:
        'https://res.cloudinary.com/nosrecettes/image/upload/w_400,h_300,c_fill,q_auto,f_auto/recipes/tartare-de-thon-fraise-et-sesame',
      medium:
        'https://res.cloudinary.com/nosrecettes/image/upload/w_800,h_600,c_fill,q_auto,f_auto/recipes/tartare-de-thon-fraise-et-sesame',
      large:
        'https://res.cloudinary.com/nosrecettes/image/upload/w_1200,h_900,c_fill,q_auto,f_auto/recipes/tartare-de-thon-fraise-et-sesame',
    },
  ],
