...
export const saagAlooPommesDeTerreIndiennesAuxEpinards: Recipe = {
  ...
  description:
    "J'adore cette manière différente de manger des pommes de terre. Saag Aloo (Pommes de terre indiennes aux épinards)",
  ...
  images: [
    {
      small:
        'https://res.cloudinary.com/nosrecettes/image/upload/w_400,h_300,c_fill,q_auto,f_auto/recipes/saag-aloo-pommes-de-terre-indiennes-aux-epinards',
      medium:
        'https://res.cloudinary.com/nosrecettes/image/upload/w_800,h_600,c_fill,q_auto,f_auto/recipes/saag-aloo-pommes-de-terre-indiennes-aux-epinards',
      large:
        'https://res.cloudinary.com/nosrecettes/image/upload/w_1200,h_900,c_fill,q_auto,f_auto/recipes/saag-aloo-pommes-de-terre-indiennes-aux-epinards',
    },
  ],
  accompaniment: 'Pain naams',
  source: 'David Cloutier',
  notes:
    "En tout temps, s'il en manque, n'hésitez pas à rajouter de l'huile d'olive.",
