...
export const ramenThaiCariCoco: Recipe = {
  ...
  description:
    "Une soupe de ramen parfumée au curry rouge, lait de coco et porc haché, garnie d'œufs pochés et de coriandre fraîche.",
  ...
  images: [
    {
      small:
        'https://res.cloudinary.com/nosrecettes/image/upload/w_400,h_300,c_fill,q_auto,f_auto/recipes/ramen-thai-cari-coco',
      medium:
        'https://res.cloudinary.com/nosrecettes/image/upload/w_800,h_600,c_fill,q_auto,f_auto/recipes/ramen-thai-cari-coco',
      large:
        'https://res.cloudinary.com/nosrecettes/image/upload/w_1200,h_900,c_fill,q_auto,f_auto/recipes/ramen-thai-cari-coco',
    },
  ],
