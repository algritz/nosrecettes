...
export const cremeDeCourgeMusqueeEtPomme: Recipe = {
  ...
  description:
    'Une soupe crémeuse à base de courge musquée et de pomme, parfumée aux épices chinoises et à la sauge.',
  categories: ['Soupes'],
  ...
  images: [
    {
      small:
        'https://res.cloudinary.com/nosrecettes/image/upload/w_400,h_300,c_fill,q_auto,f_auto/recipes/creme-de-courge-musquee-et-pomme',
      medium:
        'https://res.cloudinary.com/nosrecettes/image/upload/w_800,h_600,c_fill,q_auto,f_auto/recipes/creme-de-courge-musquee-et-pomme',
      large:
        'https://res.cloudinary.com/nosrecettes/image/upload/w_1200,h_900,c_fill,q_auto,f_auto/recipes/creme-de-courge-musquee-et-pomme',
    },
  ],
