...
export const gateauAuFromageRiceKrispiesEtChocolat: Recipe = {
  ...
  ingredients: [
    ...
    '10 oz (285 g) de mini guimauves',
    '6 tasses de céréales Rice Krispies',
    '8 oz (225 g) de chocolat mi‑sucré',
  ...
  instructions: [
    ...
    'Ajouter les Rice Krispies et remuer pour bien enrober. Transférer immédiatement dans un moule à charnière graissé de 10 po (25 cm). À l’aide d’une tasse à mesurer graissée, presser pour former le fond et les bords. Réserver.',
    'Mettre le chocolat dans un bol allant au micro‑ondes et verser la crème épaisse. Faire fondre par intervalles de 30 secondes en remuant, jusqu’à homogénéité (environ 1 minute).',
    'Dans un grand bol, battre le fromage à la crème, le sucre et la vanille jusqu’à lisse. Incorporer le chocolat fondu.',
