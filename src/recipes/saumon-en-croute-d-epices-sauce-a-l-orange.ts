...
export const saumonEnCrouteDEpicesSauceALOrange: Recipe = {
  ...
  description:
    'Une recette de saumon épicé en croûte, servi avec une sauce à l’orange, accompagné d’asperges et de polenta au parmesan.',
  ...
  notes:
    'Ne fait pas assez de croûte et de sauce. La prochaine fois nous triplerons la recette sauf le saumon.',
