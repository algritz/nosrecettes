...
export const tourtiereDuLacStyleFamilial: Recipe = {
  ...
  description:
    'Pâté en cocotte garni de viandes marinées et de pommes de terre, cuisson longue à four doux.',
  ...
  images: [
    {
      small:
        'https://res.cloudinary.com/nosrecettes/image/upload/w_400,h_300,c_fill,q_auto,f_auto/recipes/20260115_175459',
      medium:
        'https://res.cloudinary.com/nosrecettes/image/upload/w_800,h_600,c_fill,q_auto,f_auto/recipes/20260115_175459',
      large:
        'https://res.cloudinary.com/nosrecettes/image/upload/w_1200,h_900,c_fill,q_auto,f_auto/recipes/20260115_175459',
    },
  ],
  source: 'Mon papa',
