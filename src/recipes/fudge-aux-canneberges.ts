...
export const fudgeAuxCanneberges: Recipe = {
  ...
  description:
    'Un fudge aux canneberges séchées, chocolat mi-amer et lait concentré, à préparer au bain-marie et à réfrigérer pour obtenir une texture ferme et fondante.',
  ...
  notes:
    "Le temps de marinade est de 3 heures. La recette ne précise pas le nombre exact de portions, mais indique 'une gang'.",
