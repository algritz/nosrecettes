...
export const tartareDeBoeufAuxEpicesCajunsCacahuetesEtCoriandre: Recipe = {
  ...
  notes:
    "La vedette dans ce tartare, c'est le profil de saveurs provenant des épices, la viande n'est qu'un support. Donc, ne gaspillez pas votre argent en achetant votre viande dans la super boucherie \"fancy\" de votre coin. Allez-y avec un morceau simple, mais de qualité et FRAIS.",
