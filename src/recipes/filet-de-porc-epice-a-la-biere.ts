...
export const filetDePorcEpiceALaBiere: Recipe = {
  ...
  description:
    'Un filet de porc épicé mariné dans une bière rousse, grillé et servi avec une sauce brune relevée.',
  ...
  images: [
    {
      small:
        'https://res.cloudinary.com/nosrecettes/image/upload/w_400,h_300,c_fill,q_auto,f_auto/recipes/filet_porc_epice_biere',
      medium:
        'https://res.cloudinary.com/nosrecettes/image/upload/w_800,h_600,c_fill,q_auto,f_auto/recipes/filet_porc_epice_biere',
      large:
        'https://res.cloudinary.com/nosrecettes/image/upload/w_1200,h_900,c_fill,q_auto,f_auto/recipes/filet_porc_epice_biere',
    },
  ],
