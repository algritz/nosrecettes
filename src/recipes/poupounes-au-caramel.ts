...
export const poupounesAuCaramel: Recipe = {
  ...
  description:
    'Une recette de friandises enrobées de caramel et céréales Rice Krispies, façonnées en boules et congelées.',
  categories: ['Desserts'],
  ...
  images: [
    {
      small:
        'https://res.cloudinary.com/nosrecettes/image/upload/w_400,h_300,c_fill,q_auto,f_auto/recipes/poupounes-au-caramel',
      medium:
        'https://res.cloudinary.com/nosrecettes/image/upload/w_800,h_600,c_fill,q_auto,f_auto/recipes/poupounes-au-caramel',
      large:
        'https://res.cloudinary.com/nosrecettes/image/upload/w_1200,h_900,c_fill,q_auto,f_auto/recipes/poupounes-au-caramel',
    },
  ],
