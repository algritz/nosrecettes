...
export const brochettesDePouletAuLaitDeCocoEtCari: Recipe = {
  ...
  difficulty: 'Facile',
  ingredients: [
    '1 tasse de lait de coco (60 ml)',
    '1 c. à soupe de pâte de cari de madras',
    '1/4 c. à thé de sel',
  ...
  instructions: [
    ...
    'Réserver 1/4 tasse de cette marinade.',
    'Dans le grand bol, ajouter les morceaux de poulet, bien mélanger et faire mariner 4 heures.',
    '15 minutes avant la cuisson, ajouter le poivron et le brocoli, et remuer pour les enrober de la marinade. Laisser reposer 15 minutes.',
    'Préparer le BBQ.',
