...
export const barresCrunchiesAuChocolatEtBeurreDarachides: Recipe = {
  ...
  description:
    'Recette de barres crunchies au chocolat et beurre d’arachides avec ingrédients simples et préparation rapide.',
  ...
  images: [
    {
      small:
        'https://res.cloudinary.com/nosrecettes/image/upload/w_400,h_300,c_fill,q_auto,f_auto/recipes/barres-crunchies-au-chocolat-et-beurre-d-arachides',
      medium:
        'https://res.cloudinary.com/nosrecettes/image/upload/w_800,h_600,c_fill,q_auto,f_auto/recipes/barres-crunchies-au-chocolat-et-beurre-d-arachides',
      large:
        'https://res.cloudinary.com/nosrecettes/image/upload/w_1200,h_900,c_fill,q_auto,f_auto/recipes/barres-crunchies-au-chocolat-et-beurre-d-arachides',
    },
  ],
