...
export const biscuitsChocoCaramelPacaneEtBacon: Recipe = {
  ...
  instructions: [
    ...
    'Faire griller les pacanes environ 5 minutes sur une plaque à pâtisserie. Laisser refroidir.',
    'Cuire le bacon jusqu’à ce qu’il soit bien doré. Le couper en morceaux. Réserver.',
    'Hacher grossièrement les noix, le chocolat et les bonbons au caramel et mélanger au bacon refroidi.',
    'Conserver une petite quantité de ce mélange pour garnir le dessus des biscuits.',
    'Dans le bol du batteur électrique, battre le beurre et le sucre en crème jusqu’à ce que le mélange gonfle, blanchisse et prenne une consistance soyeuse.',
    'Ajouter l’œuf et mélanger de nouveau.',
    'Dans un bol, tamiser la farine, le bicarbonate et la poudre à pâte.',
    'Ajouter les ingrédients secs aux ingrédients humides, puis ajouter le bacon, les noix, le chocolat et le caramel.',
    'Mélanger juste assez pour amalgamer.',
    'Tapisser une plaque de papier parchemin ou d’un tapis de cuisson en silicone.',
