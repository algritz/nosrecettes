...
export const pouletTikkaMasala: Recipe = {
  ...
  description:
    'Un classique indien de poulet mariné et épicé, cuit au four ou au barbecue, puis mijoté dans une sauce crémeuse aux épices et tomates.',
  ...
  images: [
    {
      small:
        'https://res.cloudinary.com/nosrecettes/image/upload/w_400,h_300,c_fill,q_auto,f_auto/recipes/poulet-tikka-masala',
      medium:
        'https://res.cloudinary.com/nosrecettes/image/upload/w_800,h_600,c_fill,q_auto,f_auto/recipes/poulet-tikka-masala',
      large:
        'https://res.cloudinary.com/nosrecettes/image/upload/w_1200,h_900,c_fill,q_auto,f_auto/recipes/poulet-tikka-masala',
    },
  ],
