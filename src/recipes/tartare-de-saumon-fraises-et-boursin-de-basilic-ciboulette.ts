...
export const tartareDeSaumonFraisesEtBoursinDeBasilicCiboulette: Recipe = {
  ...
  difficulty: 'Facile',
  ingredients: [
    'Fromage Boursin Bouquet de basilic & Ciboulette',
    '8 oz de saumon très frais coupé en petits cubes',
    '5 fraises coupées en petits cubes',
    '5 grosses feuilles de basilic ciselées',
  ...
  instructions: [
    ...
    'Couper le saumon et les fraises en petits cubes.',
