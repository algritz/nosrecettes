...
export const risottoAuChampignonCrabe: Recipe = {
  ...
  description:
    'Une recette de risotto utilisant des champignons crabe, idéale pour utiliser ces ingrédients frais et savoureux.',
  ...
  images: [
    {
      small:
        'https://res.cloudinary.com/nosrecettes/image/upload/w_400,h_300,c_fill,q_auto,f_auto/recipes/risotto-au-champignon-crabe',
      medium:
        'https://res.cloudinary.com/nosrecettes/image/upload/w_800,h_600,c_fill,q_auto,f_auto/recipes/risotto-au-champignon-crabe',
      large:
        'https://res.cloudinary.com/nosrecettes/image/upload/w_1200,h_900,c_fill,q_auto,f_auto/recipes/risotto-au-champignon-crabe',
    },
  ],
