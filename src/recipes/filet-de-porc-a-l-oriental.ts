...
export const filetDePorcALOriental: Recipe = {
  ...
  notes: 'Marinage de 4 heures et plus. Optionnellement, précuire des pommes de terre en quartiers ou grelots 15 minutes avant la cuisson des légumes, puis ajouter les légumes et le porc pour poursuivre la cuisson.',
