...
export const pouletALorange: Recipe = {
  ...
  description:
    "Poulet à l'orange avec une sauce acidulée à base de jus d'orange, citron, vinaigre de riz et sauce soja, servi sur du riz avec échalotes.",
  ...
  images: [
    {
      small:
        'https://res.cloudinary.com/nosrecettes/image/upload/w_400,h_300,c_fill,q_auto,f_auto/recipes/poulet-a-l-orange',
      medium:
        'https://res.cloudinary.com/nosrecettes/image/upload/w_800,h_600,c_fill,q_auto,f_auto/recipes/poulet-a-l-orange',
      large:
        'https://res.cloudinary.com/nosrecettes/image/upload/w_1200,h_900,c_fill,q_auto,f_auto/recipes/poulet-a-l-orange',
    },
  ],
