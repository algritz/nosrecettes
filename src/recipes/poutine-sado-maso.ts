...
export const poutineSadoMaso: Recipe = {
  ...
  description:
    'Une version riche et savoureuse de la poutine avec du canard confit et une sauce onctueuse parfumée aux épices jamaïcaines.',
  ...
  notes:
    "Lorsque la sauce commence à vouloir se séparer lorsqu'elle mijote, c'est qu'elle est prête : servir immédiatement. Bien éponger les frites avant de les mettre dans les bols.",
