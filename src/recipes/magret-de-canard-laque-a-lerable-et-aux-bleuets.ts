...
export const magretDeCanardLaqueALerableEtAuxBleuets: Recipe = {
  ...
  description:
    'Un magret de canard laqué à l’érable et aux bleuets, cuit au four pour une finition brillante et savoureuse.',
  ...
  images: [
    {
      small:
        'https://res.cloudinary.com/nosrecettes/image/upload/w_400,h_300,c_fill,q_auto,f_auto/recipes/magret-de-canard-laque-a-l-erable-et-aux-bleuets',
      medium:
        'https://res.cloudinary.com/nosrecettes/image/upload/w_800,h_600,c_fill,q_auto,f_auto/recipes/magret-de-canard-laque-a-l-erable-et-aux-bleuets',
      large:
        'https://res.cloudinary.com/nosrecettes/image/upload/w_1200,h_900,c_fill,q_auto,f_auto/recipes/magret-de-canard-laque-a-l-erable-et-aux-bleuets',
    },
  ],
