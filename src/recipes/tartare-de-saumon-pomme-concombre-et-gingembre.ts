...
export const tartareDeSaumonPommeConcombreEtGingembre: Recipe = {
  ...
  description:
    "Un tartare frais et épicé combinant saumon, pomme, concombre et gingembre, accompagné d'une mayonnaise épicée maison.",
  categories: ['Entrées'],
  ...
  images: [
    {
      small:
        'https://res.cloudinary.com/nosrecettes/image/upload/w_400,h_300,c_fill,q_auto,f_auto/recipes/tartare-de-saumon-pomme-concombre-et-gingembre',
      medium:
        'https://res.cloudinary.com/nosrecettes/image/upload/w_800,h_600,c_fill,q_auto,f_auto/recipes/tartare-de-saumon-pomme-concombre-et-gingembre',
      large:
        'https://res.cloudinary.com/nosrecettes/image/upload/w_1200,h_900,c_fill,q_auto,f_auto/recipes/tartare-de-saumon-pomme-concombre-et-gingembre',
    },
  ],
