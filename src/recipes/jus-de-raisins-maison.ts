...
export const jusDeRaisinsMaison: Recipe = {
  ...
  servings: 0,
  difficulty: 'Facile',
  ingredients: ['Beaucoup de raisins frais'],
  instructions: [
  ...
  images: [
    {
      small:
        'https://res.cloudinary.com/nosrecettes/image/upload/w_400,h_300,c_fill,q_auto,f_auto/recipes/jus-de-raisins-maison',
      medium:
        'https://res.cloudinary.com/nosrecettes/image/upload/w_800,h_600,c_fill,q_auto,f_auto/recipes/jus-de-raisins-maison',
      large:
        'https://res.cloudinary.com/nosrecettes/image/upload/w_1200,h_900,c_fill,q_auto,f_auto/recipes/jus-de-raisins-maison',
    },
  ],
