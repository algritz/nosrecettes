...
export const poivronsTandoori: Recipe = {
  ...
  description:
    'Poivrons farcis épicés et grillés, marinés dans une sauce citronnée, servis chauds ou tièdes.',
  ...
  ingredients: [
    {
      title: 'Poivrons',
      items: ['4 gros poivrons jaunes, rouges ou verts'],
    },
    {
      title: 'Farce',
      items: [
  ...
  images: [
    {
      small:
        'https://res.cloudinary.com/nosrecettes/image/upload/w_400,h_300,c_fill,q_auto,f_auto/recipes/poivrons-tandoori',
      medium:
        'https://res.cloudinary.com/nosrecettes/image/upload/w_800,h_600,c_fill,q_auto,f_auto/recipes/poivrons-tandoori',
      large:
        'https://res.cloudinary.com/nosrecettes/image/upload/w_1200,h_900,c_fill,q_auto,f_auto/recipes/poivrons-tandoori',
    },
  ],
