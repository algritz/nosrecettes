...
export const filetDeSaumonAuxEpinardsEtAuxTomatesSeches: Recipe = {
  ...
  title: 'Filet de saumon aux épinards et aux tomates séchés',
  description: '',
  ...
  instructions: [
    ...
    'Ensuite étendre un peu de vinaigrette dans le fond d’un plat allant au four et y déposer le filet de saumon.',
    'Étendre un peu de vinaigrette sur le saumon.',
    'Saler et poivrer.',
    'Faire revenir dans un peu d’huile d’olive l’oignon coupé en lamelle et l’ail.',
    'Ensuite ajouter les épinards bien lavés et séchés.',
