...
export const vinaigretteCesarMaison: Recipe = {
  ...
  description:
    'Une vinaigrette classique César faite maison, crémeuse et savoureuse, idéale pour accompagner vos salades.',
  categories: ['Sauces'],
  ...
  images: [
    {
      small:
        'https://res.cloudinary.com/nosrecettes/image/upload/w_400,h_300,c_fill,q_auto,f_auto/recipes/vinaigrette-cesar-maison',
      medium:
        'https://res.cloudinary.com/nosrecettes/image/upload/w_800,h_600,c_fill,q_auto,f_auto/recipes/vinaigrette-cesar-maison',
      large:
        'https://res.cloudinary.com/nosrecettes/image/upload/w_1200,h_900,c_fill,q_auto,f_auto/recipes/vinaigrette-cesar-maison',
    },
  ],
