...
export const sauteDeCanard: Recipe = {
  ...
  description:
    'Sauté de canard avec légumes sautés et sauce soja au miel, servi avec pâtes ou riz thaï.',
  ...
  images: [
    {
      small:
        'https://res.cloudinary.com/nosrecettes/image/upload/w_400,h_300,c_fill,q_auto,f_auto/recipes/saute-de-canard',
      medium:
        'https://res.cloudinary.com/nosrecettes/image/upload/w_800,h_600,c_fill,q_auto,f_auto/recipes/saute-de-canard',
      large:
        'https://res.cloudinary.com/nosrecettes/image/upload/w_1200,h_900,c_fill,q_auto,f_auto/recipes/saute-de-canard',
    },
  ],
