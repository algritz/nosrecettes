...
export const tartareDeBUfParmesanBalsamiqueEtPestoDeTomates: Recipe = {
  ...
  difficulty: 'Facile',
  ingredients: [
    '500 g de filet mignon, coupé en petits cubes',
    ...
    '1 c. à soupe de pesto de tomates',
  ...
  instructions: [
    ...
    'Dans un autre bol, mélanger le filet mignon avec le fromage parmesan, l’échalote, la ciboulette et le persil.',
