...
export const pateAModelerAuSucreDErableComestible: Recipe = {
  ...
  description:
    'Une pâte à modeler comestible à base de sucre et de sirop d’érable, idéale pour décorer ou jouer.',
  ...
  notes:
    'Essayer la même recette mais avec des essences différentes pour remplacer la vanille (banane, orange, amande, etc.). Utiliser cette pâte pour décorer vos desserts favoris.',
