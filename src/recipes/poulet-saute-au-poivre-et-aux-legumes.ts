...
export const pouletSauteAuPoivreEtAuxLegumes: Recipe = {
  ...
  description:
    'Une recette de poulet sauté parfumé au poivre, accompagné de légumes blanchis et de Boursin Cuisine Trois Poivres, servi avec une touche de citron et de cerfeuil.',
  ...
  notes:
    "Pour blanchir des légumes, faites bouillir de l'eau salée dans une casserole. Lorsque l'eau arrive à ébullition, versez les légumes dans la casserole. Retirez les légumes lorsque l'eau recommence à bouillir puis plongez-les dans un récipient contenant de l'eau froide.",
