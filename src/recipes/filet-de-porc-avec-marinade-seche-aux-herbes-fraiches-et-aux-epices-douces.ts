...
export const filetDePorcAvecMarinadeSecheAuxHerbesFraichesEtAuxEpicesDouces: Recipe =
  {
    ...
    title:
      'Filet de porc avec marinade sèche aux herbes fraîches et aux épices douces',
    description:
      'Une recette de filet de porc en marinade sèche aux herbes fraîches et épices douces, idéal pour une cuisson au barbecue ou au four, servi en tranches avec une salade de pâtes et légumes frais.',
