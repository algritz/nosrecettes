...
export const tartareDeBoeufAuMascarponeEtAuxCanneberges: Recipe = {
  ...
  description:
    "Un tartare de boeuf frais et savoureux, accompagné d'une sauce au mascarpone et de canneberges, parfait pour une entrée élégante.",
  categories: ['Entrées'],
  ...
  images: [
    {
      small:
        'https://res.cloudinary.com/nosrecettes/image/upload/w_400,h_300,c_fill,q_auto,f_auto/recipes/tartare-de-boeuf-au-mascarpone-et-aux-canneberges',
      medium:
        'https://res.cloudinary.com/nosrecettes/image/upload/w_800,h_600,c_fill,q_auto,f_auto/recipes/tartare-de-boeuf-au-mascarpone-et-aux-canneberges',
      large:
        'https://res.cloudinary.com/nosrecettes/image/upload/w_1200,h_900,c_fill,q_auto,f_auto/recipes/tartare-de-boeuf-au-mascarpone-et-aux-canneberges',
    },
  ],
