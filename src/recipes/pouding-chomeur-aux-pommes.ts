...
export const poudingChomeurAuxPommes: Recipe = {
  ...
  description:
    'Un dessert classique québécois combinant un sirop aux pommes chaud avec un gâteau moelleux à la vanille, servi tiède ou froid.',
  categories: ['Desserts'],
  ...
  images: [
    {
      small:
        'https://res.cloudinary.com/nosrecettes/image/upload/w_400,h_300,c_fill,q_auto,f_auto/recipes/pouding_chomeur_aux_pommes',
      medium:
        'https://res.cloudinary.com/nosrecettes/image/upload/w_800,h_600,c_fill,q_auto,f_auto/recipes/pouding_chomeur_aux_pommes',
      large:
        'https://res.cloudinary.com/nosrecettes/image/upload/w_1200,h_900,c_fill,q_auto,f_auto/recipes/pouding_chomeur_aux_pommes',
    },
  ],
  source: 'David Cloutier',
  notes:
    'Si le sirop est trop liquide, mettre 4 c à thé de fécule de maïs au lieu de 2.',
