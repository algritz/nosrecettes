...
export const bouleAuOreo: Recipe = {
  ...
  title: 'Boule au Oréo',
  description:
    'Une recette de boules à base de biscuits Oreo, fromage à la crème et chocolat, enrobées de chocolat fondu et de miettes de biscuits.',
  categories: ['Desserts'],
  ...
  images: [
    {
      small:
        'https://res.cloudinary.com/nosrecettes/image/upload/w_400,h_300,c_fill,q_auto,f_auto/recipes/boule-au-oreo',
      medium:
        'https://res.cloudinary.com/nosrecettes/image/upload/w_800,h_600,c_fill,q_auto,f_auto/recipes/boule-au-oreo',
      large:
        'https://res.cloudinary.com/nosrecettes/image/upload/w_1200,h_900,c_fill,q_auto,f_auto/recipes/boule-au-oreo',
    },
  ],
