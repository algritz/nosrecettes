...
export const magretsDeCanardAu2Moutardes: Recipe = {
  ...
  description:
    'Magrets saisis puis rôtis, nappés d’une sauce au vin blanc, crème et double moutarde.',
  ...
  images: [
    {
      small:
        'https://res.cloudinary.com/nosrecettes/image/upload/w_400,h_300,c_fill,q_auto,f_auto/recipes/magret_2_moutardes',
      medium:
        'https://res.cloudinary.com/nosrecettes/image/upload/w_800,h_600,c_fill,q_auto,f_auto/recipes/magret_2_moutardes',
      large:
        'https://res.cloudinary.com/nosrecettes/image/upload/w_1200,h_900,c_fill,q_auto,f_auto/recipes/magret_2_moutardes',
    },
  ],
