...
export const pouletALindienneAvecSauceAuYogourtEtRizALaMangue: Recipe = {
  ...
  description:
    'Un plat indien savoureux avec poulet mariné, sauce au yogourt à la mangue, servi avec du riz jasmin parfumé.',
  ...
  slug: 'poulet-a-lindienne-avec-sauce-au-yogourt-et-riz-a-la-mangue',
}
