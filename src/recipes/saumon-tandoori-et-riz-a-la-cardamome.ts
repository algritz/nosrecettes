...
export const saumonTandooriEtRizALaCardamome: Recipe = {
  ...
  description:
    'Un plat parfumé de saumon tandoori servi avec un riz à la cardamome, idéal pour un repas savoureux et épicé.',
  ...
  images: [
    {
      small:
        'https://res.cloudinary.com/nosrecettes/image/upload/w_400,h_300,c_fill,q_auto,f_auto/recipes/saumon-tandoori-et-riz-a-la-cardamome',
      medium:
        'https://res.cloudinary.com/nosrecettes/image/upload/w_800,h_600,c_fill,q_auto,f_auto/recipes/saumon-tandoori-et-riz-a-la-cardamome',
      large:
        'https://res.cloudinary.com/nosrecettes/image/upload/w_1200,h_900,c_fill,q_auto,f_auto/recipes/saumon-tandoori-et-riz-a-la-cardamome',
    },
  ],
