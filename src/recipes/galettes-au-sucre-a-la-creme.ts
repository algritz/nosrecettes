...
export const galettesAuSucreALaCreme: Recipe = {
  ...
  description:
    'Une recette de galettes sucrées avec un crémage au beurre et sucre glace, parfaites pour une douceur maison.',
  ...
  notes:
    'Temps de préparation: 20 à 25 minutes, cuisson: 12 à 15 minutes, source: Lynda Morin.',
