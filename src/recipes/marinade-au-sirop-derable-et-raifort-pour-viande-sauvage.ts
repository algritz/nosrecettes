...
export const marinadeAuSiropDerableEtRaifortPourViandeSauvage: Recipe = {
  ...
  description:
    "Une marinade savoureuse à base de sirop d'érable et raifort, idéale pour la viande de gibier ou autres viandes sauvages, à préparer avant de griller.",
  categories: ['Marinade'],
  ...
  slug: 'marinade-au-sirop-derable-et-raifort-pour-viande-sauvage',
}
