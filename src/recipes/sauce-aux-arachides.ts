...
export const sauceAuxArachides: Recipe = {
  ...
  description:
    "Une sauce crémeuse et épicée à base de beurre d'arachide, lait de coco, paprika et sauce poisson, idéale pour accompagner des brochettes ou rouleaux de printemps.",
  ...
  images: [
    {
      small:
        'https://res.cloudinary.com/nosrecettes/image/upload/w_400,h_300,c_fill,q_auto,f_auto/recipes/sauce-aux-arachides',
      medium:
        'https://res.cloudinary.com/nosrecettes/image/upload/w_800,h_600,c_fill,q_auto,f_auto/recipes/sauce-aux-arachides',
      large:
        'https://res.cloudinary.com/nosrecettes/image/upload/w_1200,h_900,c_fill,q_auto,f_auto/recipes/sauce-aux-arachides',
    },
  ],
