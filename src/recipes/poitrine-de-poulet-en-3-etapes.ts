...
export const poitrineDePouletEn3Etapes: Recipe = {
  ...
  description:
    'Une recette de poulet mariné en trois étapes, avec une marinade sèche, une marinade liquide, et une sauce BBQ pour une cuisson au grill.',
  ...
  notes:
    'Pour que ce soit moins salé, mettre de la sauce soya et du beurre non-salé.',
