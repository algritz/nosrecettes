...
export const ragoutDeBoulettes: Recipe = {
  ...
  description:
    'Ragoût de boulettes bœuf-porc avec légumes, bouillon épaissi à la farine grillée, cuisson au four.',
  ...
  images: [
    {
      small:
        'https://res.cloudinary.com/nosrecettes/image/upload/w_400,h_300,c_fill,q_auto,f_auto/recipes/ragout_de_boulettes',
      medium:
        'https://res.cloudinary.com/nosrecettes/image/upload/w_800,h_600,c_fill,q_auto,f_auto/recipes/ragout_de_boulettes',
      large:
        'https://res.cloudinary.com/nosrecettes/image/upload/w_1200,h_900,c_fill,q_auto,f_auto/recipes/ragout_de_boulettes',
    },
  ],
