...
export const tartareDeMagretsDeCanardAuPoivreDeSichuan: Recipe = {
  ...
  description:
    "Un tartare de magret de canard relevé au poivre de Sichuan, servi avec une garniture de luzerne et assaisonné d'huile d'olive et de vinaigre balsamique.",
  categories: ['Entrées'],
  ...
  notes:
    'Si vous n’avez pas de poivre de Sichuan, vous pouvez employer un poivre noir classique. N’hésitez pas à essayer différentes sortes de poivre : mignonnette, poivre long, etc..',
