...
export const saladeDeKaleClementineQuinoaEtNoixDeGrenoble: Recipe = {
  ...
  description:
    "Une salade fraîche et nutritive combinant kale, clémentines, quinoa et noix de Grenoble, agrémentée d'une vinaigrette onctueuse à l'érable.",
  categories: ['Salades'],
  ...
  images: [
    {
      small:
        'https://res.cloudinary.com/nosrecettes/image/upload/w_400,h_300,c_fill,q_auto,f_auto/recipes/salade_de_kale_clementine',
      medium:
        'https://res.cloudinary.com/nosrecettes/image/upload/w_800,h_600,c_fill,q_auto,f_auto/recipes/salade_de_kale_clementine',
      large:
        'https://res.cloudinary.com/nosrecettes/image/upload/w_1200,h_900,c_fill,q_auto,f_auto/recipes/salade_de_kale_clementine',
    },
  ],
