...
export const boucheesDeBiscuitAuGateauAuFromage: Recipe = {
  ...
  description:
    'Une recette de bouchées de biscuit au gâteau au fromage, combinant une base de pâte chocolatée avec une garniture crémeuse au fromage, à cuire et réfrigérer avant de servir.',
  ...
  notes:
    'Temps total de préparation et cuisson: 40 minutes. Temps de refroidissement recommandé: au moins 6 heures ou toute la nuit.',
