...
export const barresNanaimo: Recipe = {
  ...
  description:
    'Une recette de barres chocolatées et vanillées, décorées pour ressembler à des dominos, avec une base croustillante, une garniture à la vanille, et un glaçage au chocolat.',
