...
export const cremeDeBettraves: Recipe = {
  ...
  description:
    'Une soupe de betteraves crémeuse et parfumée, idéale pour une entrée ou un repas léger.',
  categories: ['Soupes'],
  ...
  images: [
    {
      small:
        'https://res.cloudinary.com/nosrecettes/image/upload/w_400,h_300,c_fill,q_auto,f_auto/recipes/creme_de_bettrave',
      medium:
        'https://res.cloudinary.com/nosrecettes/image/upload/w_800,h_600,c_fill,q_auto,f_auto/recipes/creme_de_bettrave',
      large:
        'https://res.cloudinary.com/nosrecettes/image/upload/w_1200,h_900,c_fill,q_auto,f_auto/recipes/creme_de_bettrave',
    },
  ],
