...
export const cremeDeNavetEtPoireauALerable: Recipe = {
  ...
  instructions: [
    ...
    'Ajouter les cubes de navet à la casserole et poursuivre la cuisson 3 minutes.',
    'Ajouter le bouillon de poulet et amener à ébullition.',
    'Dès les premiers bouillons, réduire la chaleur et laisser mijoter 30 minutes environ, jusqu’à tendreté du rutabaga.',
  ...
  images: [
    {
      small:
        'https://res.cloudinary.com/nosrecettes/image/upload/w_400,h_300,c_fill,q_auto,f_auto/recipes/creme_navet_et_poireau',
      medium:
        'https://res.cloudinary.com/nosrecettes/image/upload/w_800,h_600,c_fill,q_auto,f_auto/recipes/creme_navet_et_poireau',
      large:
        'https://res.cloudinary.com/nosrecettes/image/upload/w_1200,h_900,c_fill,q_auto,f_auto/recipes/creme_navet_et_poireau',
    },
  ],
