...
export const gateauDansUneTasseDeMesEnfants: Recipe = {
  ...
  description:
    'Un gâteau au chocolat rapide et facile à préparer dans une tasse, parfait pour une personne.',
  categories: ['Desserts'],
  ...
  images: [
    {
      small:
        'https://res.cloudinary.com/nosrecettes/image/upload/w_400,h_300,c_fill,q_auto,f_auto/recipes/gateau-dans-une-tasse-de-mes-enfants',
      medium:
        'https://res.cloudinary.com/nosrecettes/image/upload/w_800,h_600,c_fill,q_auto,f_auto/recipes/gateau-dans-une-tasse-de-mes-enfants',
      large:
        'https://res.cloudinary.com/nosrecettes/image/upload/w_1200,h_900,c_fill,q_auto,f_auto/recipes/gateau-dans-une-tasse-de-mes-enfants',
    },
  ],
