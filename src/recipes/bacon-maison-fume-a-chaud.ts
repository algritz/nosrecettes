...
export const baconMaisonFumeAChaud: Recipe = {
  ...
  description:
    "Le bacon d'épicerie peut aller se ré-habiller! Bacon maison fumé à chaud",
  categories: ['Porc', 'Fumoir'],
  ...
  images: [
    {
      small:
        'https://res.cloudinary.com/nosrecettes/image/upload/w_400,h_300,c_fill,q_auto,f_auto/recipes/bacon-maison-fume-a-chaud',
      medium:
        'https://res.cloudinary.com/nosrecettes/image/upload/w_800,h_600,c_fill,q_auto,f_auto/recipes/bacon-maison-fume-a-chaud',
      large:
        'https://res.cloudinary.com/nosrecettes/image/upload/w_1200,h_900,c_fill,q_auto,f_auto/recipes/bacon-maison-fume-a-chaud',
    },
  ],
  source: 'David Cloutier',
  notes:
    'Temps de marinade de 48 heures, cuisson entre 3h30 et 4h, repos de 8 heures ou toute la nuit.',
