...
export const filetDePorcAuBaconEtAuCheddar: Recipe = {
  ...
  description:
    'Un délicieux filet de porc farci au bacon et au cheddar, cuit au four avec des oignons et une sauce crémeuse au vin blanc.',
  ...
  images: [
    {
      small:
        'https://res.cloudinary.com/nosrecettes/image/upload/w_400,h_300,c_fill,q_auto,f_auto/recipes/filet-de-porc-au-bacon-et-au-cheddar',
      medium:
        'https://res.cloudinary.com/nosrecettes/image/upload/w_800,h_600,c_fill,q_auto,f_auto/recipes/filet-de-porc-au-bacon-et-au-cheddar',
      large:
        'https://res.cloudinary.com/nosrecettes/image/upload/w_1200,h_900,c_fill,q_auto,f_auto/recipes/filet-de-porc-au-bacon-et-au-cheddar',
    },
  ],
