...
export const tarteAuBeurreDarachideEtAuChocolat: Recipe = {
  ...
  description:
    "Une tarte gourmande au beurre d'arachide et au chocolat, avec une croûte croustillante et une garniture crémeuse et chocolatée.",
  ...
  images: [
    {
      small:
        'https://res.cloudinary.com/nosrecettes/image/upload/w_400,h_300,c_fill,q_auto,f_auto/recipes/tarte_beurre_arachide_chocolat',
      medium:
        'https://res.cloudinary.com/nosrecettes/image/upload/w_800,h_600,c_fill,q_auto,f_auto/recipes/tarte_beurre_arachide_chocolat',
      large:
        'https://res.cloudinary.com/nosrecettes/image/upload/w_1200,h_900,c_fill,q_auto,f_auto/recipes/tarte_beurre_arachide_chocolat',
    },
  ],
