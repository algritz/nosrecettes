...
export const gateauAuFromageUltraChocolate: Recipe = {
  ...
  description:
    'Un gâteau au fromage riche en chocolat avec une croûte croquante, une garniture fondante et une ganache onctueuse, décoré de chocolat Aéro Bubbles.',
  categories: ['Desserts'],
  ...
  ingredients: [
    ...
    },
    {
      ...
      items: ['6 oz de chocolat mi-sucré haché', '1/3 tasse de crème à 35%'],
    },
    {
      title: 'Garniture',
      items: ['Un sac de chocolat Aéro Bubbles'],
    },
  ],
  instructions: [
  ...
  images: [
    {
      small:
        'https://res.cloudinary.com/nosrecettes/image/upload/w_400,h_300,c_fill,q_auto,f_auto/recipes/gateau-au-fromage-ultra-chocolate',
      medium:
        'https://res.cloudinary.com/nosrecettes/image/upload/w_800,h_600,c_fill,q_auto,f_auto/recipes/gateau-au-fromage-ultra-chocolate',
      large:
        'https://res.cloudinary.com/nosrecettes/image/upload/w_1200,h_900,c_fill,q_auto,f_auto/recipes/gateau-au-fromage-ultra-chocolate',
    },
  ],
