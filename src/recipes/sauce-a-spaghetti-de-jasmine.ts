...
export const sauceASpaghettiDeJasmine: Recipe = {
  ...
  description:
    'Une sauce à spaghetti riche et savoureuse, mijotée lentement pour développer toutes ses saveurs, idéale pour accompagner vos pâtes ou autres plats italiens.',
