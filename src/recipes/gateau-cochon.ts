...
export const gateauCochon: Recipe = {
  ...
  title: 'Gâteau cochon',
  description:
    'Sans farce, même les gens les plus anti-dessert y trouvent leur compte. Non, sans farce, même les gens les plus anti-dessert y trouvent leur compte.',
  ...
  images: [
    {
      small:
        'https://res.cloudinary.com/nosrecettes/image/upload/w_400,h_300,c_fill,q_auto,f_auto/recipes/gateau-cochon',
      medium:
        'https://res.cloudinary.com/nosrecettes/image/upload/w_800,h_600,c_fill,q_auto,f_auto/recipes/gateau-cochon',
      large:
        'https://res.cloudinary.com/nosrecettes/image/upload/w_1200,h_900,c_fill,q_auto,f_auto/recipes/gateau-cochon',
    },
  ],
