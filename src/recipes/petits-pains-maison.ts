...
export const petitsPainsMaison: Recipe = {
  ...
  description:
    'Recette de petits pains maison moelleux et faciles à faire, avec une pâte levée, cuits au four et badigeonnés de beurre fondu.',
  categories: ['Pain'],
  ...
  images: [
    {
      small:
        'https://res.cloudinary.com/nosrecettes/image/upload/w_400,h_300,c_fill,q_auto,f_auto/recipes/petits-pains-maison',
      medium:
        'https://res.cloudinary.com/nosrecettes/image/upload/w_800,h_600,c_fill,q_auto,f_auto/recipes/petits-pains-maison',
      large:
        'https://res.cloudinary.com/nosrecettes/image/upload/w_1200,h_900,c_fill,q_auto,f_auto/recipes/petits-pains-maison',
    },
  ],
