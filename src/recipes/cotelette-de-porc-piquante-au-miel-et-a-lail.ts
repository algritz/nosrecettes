...
export const coteletteDePorcPiquanteAuMielEtALail: Recipe = {
  ...
  description:
    "Une recette de côtelettes de porc marinées dans une sauce savoureuse, puis grillées et servies avec une sauce BBQ piquante au miel et à l'ail.",
  ...
  ingredients: [
    {
      title: 'Protéines',
      items: ['5-6 côtelettes de porc épaisses'],
    },
    {
      title: 'Marinade',
      items: [
