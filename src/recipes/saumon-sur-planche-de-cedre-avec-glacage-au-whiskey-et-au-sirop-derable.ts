...
export const saumonSurPlancheDeCedreAvecGlacageAuWhiskeyEtAuSiropDerable: Recipe =
  {
    ...
    title:
      "Saumon sur planche de cèdre avec glaçage au whiskey et au sirop d'érable",
    description:
      "Saumon cuit sur planche de cèdre avec un glaçage au whiskey et sirop d'érable, servi avec citron et persil.",
    categories: ['Poisson', 'Plats principaux', 'Barbecue'],
    ...
    slug: 'saumon-sur-planche-de-cedre-avec-glacage-au-whiskey-et-au-sirop-derable',
  }
