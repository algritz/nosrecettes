...
export const ragoutDeBoeufAuxLegumes: Recipe = {
  ...
  description:
    'Un ragoût de boeuf mijoté avec légumes variés, parfumé aux herbes et au vin rouge, idéal pour un plat réconfortant.',
  ...
  notes:
    'Mettre la courge en même temps que les pommes de terre, sinon elle se transformera en bouette.',
