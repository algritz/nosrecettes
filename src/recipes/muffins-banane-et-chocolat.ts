...
export const muffinsBananeEtChocolat: Recipe = {
  ...
  description:
    'Recette de muffins moelleux à la banane et aux pépites de chocolat, parfaits pour un goûter ou un petit-déjeuner.',
  ...
  images: [
    {
      small:
        'https://res.cloudinary.com/nosrecettes/image/upload/w_400,h_300,c_fill,q_auto,f_auto/recipes/muffins-banane-et-chocolat',
      medium:
        'https://res.cloudinary.com/nosrecettes/image/upload/w_800,h_600,c_fill,q_auto,f_auto/recipes/muffins-banane-et-chocolat',
      large:
        'https://res.cloudinary.com/nosrecettes/image/upload/w_1200,h_900,c_fill,q_auto,f_auto/recipes/muffins-banane-et-chocolat',
    },
  ],
