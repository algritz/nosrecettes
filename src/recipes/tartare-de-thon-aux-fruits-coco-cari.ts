...
export const tartareDeThonAuxFruitsCocoCari: Recipe = {
  ...
  difficulty: 'Facile',
  ingredients: [
    '700g de thon coupé en petits dés',
    '1/2 banane pas trop molle coupée en dés',
    '1/2 pomme granny smith coupée en dés',
  ...
  instructions: [
    ...
    'Arroser de jus de citron vert, salez, poivrez, ajoutez les oignons verts ciselés mais gardez-en un peu pour la décoration.',
    'Mélangez.',
