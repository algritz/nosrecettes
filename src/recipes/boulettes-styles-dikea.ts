...
export const boulettesStylesDikea: Recipe = {
  ...
  description:
    'Recette de boulettes de viande à la sauce à la crème, inspirée du style IKEA, pour 4 personnes.',
  ...
  images: [
    {
      small:
        'https://res.cloudinary.com/nosrecettes/image/upload/w_400,h_300,c_fill,q_auto,f_auto/recipes/boulettes-styles-d-ikea',
      medium:
        'https://res.cloudinary.com/nosrecettes/image/upload/w_800,h_600,c_fill,q_auto,f_auto/recipes/boulettes-styles-d-ikea',
      large:
        'https://res.cloudinary.com/nosrecettes/image/upload/w_1200,h_900,c_fill,q_auto,f_auto/recipes/boulettes-styles-d-ikea',
    },
  ],
  source: 'David Cloutier',
  notes:
    'Temps de préparation : 20 minutes. Temps de cuisson : 40 à 50 minutes. Accompagnement suggéré : pommes de terre, recette de votre choix.',
