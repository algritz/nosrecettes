...
export const tartareDeThonALaPommeMayonnaiseEpiceeASaveurDEte: Recipe = {
  ...
  description:
    "Un tartare rafraîchissant de thon à la pomme avec une mayonnaise épicée, parfait pour l'été.",
  categories: ['Entrées'],
  ...
  source:
    'https://www.iga.net/fr/recettes_inspirantes/recettes/tartare_de_thon_a_la_pomme_mayonnaise_epicee',
