...
export const brieALerablePommesEtBacon: Recipe = {
  ...
  description:
    "Un brie chaud et coulant en apéro c'est toujours gagnant Brie à l’érable, pommes et bacon",
  categories: ['Entrées'],
  ...
  images: [
    {
      small:
        'https://res.cloudinary.com/nosrecettes/image/upload/w_400,h_300,c_fill,q_auto,f_auto/recipes/brie-a-l-erable-pommes-et-bacon',
      medium:
        'https://res.cloudinary.com/nosrecettes/image/upload/w_800,h_600,c_fill,q_auto,f_auto/recipes/brie-a-l-erable-pommes-et-bacon',
      large:
        'https://res.cloudinary.com/nosrecettes/image/upload/w_1200,h_900,c_fill,q_auto,f_auto/recipes/brie-a-l-erable-pommes-et-bacon',
    },
  ],
