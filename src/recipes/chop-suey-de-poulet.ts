...
export const chopSueyDePoulet: Recipe = {
  ...
  description:
    'Un plat chinois rapide et savoureux à base de poulet, légumes croquants et fèves germées, mijoté dans une sauce soja et bouillon.',
  ...
  images: [
    {
      small:
        'https://res.cloudinary.com/nosrecettes/image/upload/w_400,h_300,c_fill,q_auto,f_auto/recipes/chop_suey_poulet',
      medium:
        'https://res.cloudinary.com/nosrecettes/image/upload/w_800,h_600,c_fill,q_auto,f_auto/recipes/chop_suey_poulet',
      large:
        'https://res.cloudinary.com/nosrecettes/image/upload/w_1200,h_900,c_fill,q_auto,f_auto/recipes/chop_suey_poulet',
    },
  ],
