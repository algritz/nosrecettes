...
export const penneALaVodka: Recipe = {
  ...
  description:
    'Pâtes au bœuf haché dans une sauce tomate–vodka crémée, relevée de piment rouge.',
  ...
  images: [
    {
      small:
        'https://res.cloudinary.com/nosrecettes/image/upload/w_400,h_300,c_fill,q_auto,f_auto/recipes/penne_a_la_vodka',
      medium:
        'https://res.cloudinary.com/nosrecettes/image/upload/w_800,h_600,c_fill,q_auto,f_auto/recipes/penne_a_la_vodka',
      large:
        'https://res.cloudinary.com/nosrecettes/image/upload/w_1200,h_900,c_fill,q_auto,f_auto/recipes/penne_a_la_vodka',
    },
  ],
