...
export const sauceBarbecueALaCassonadeEtAuBourbon: Recipe = {
  ...
  description:
    'Une sauce barbecue épaisse, relevée et parfumée au bourbon, idéale pour accompagner des côtes levées ou du pulled pork.',
  categories: ['Sauces'],
  ...
  images: [
    {
      small:
        'https://res.cloudinary.com/nosrecettes/image/upload/w_400,h_300,c_fill,q_auto,f_auto/recipes/sauce-barbecue-a-la-cassonade-et-au-bourbon',
      medium:
        'https://res.cloudinary.com/nosrecettes/image/upload/w_800,h_600,c_fill,q_auto,f_auto/recipes/sauce-barbecue-a-la-cassonade-et-au-bourbon',
      large:
        'https://res.cloudinary.com/nosrecettes/image/upload/w_1200,h_900,c_fill,q_auto,f_auto/recipes/sauce-barbecue-a-la-cassonade-et-au-bourbon',
    },
  ],
  wine: '7 Deadly Zin',
