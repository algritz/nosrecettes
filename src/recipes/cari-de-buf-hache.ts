...
export const cariDeBufHache: Recipe = {
  ...
  description:
    'Un curry savoureux à base de bœuf haché, légumes et épices, servi avec du riz blanc.',
  ...
  images: [
    {
      small:
        'https://res.cloudinary.com/nosrecettes/image/upload/w_400,h_300,c_fill,q_auto,f_auto/recipes/cari-de-b-uf-hache',
      medium:
        'https://res.cloudinary.com/nosrecettes/image/upload/w_800,h_600,c_fill,q_auto,f_auto/recipes/cari-de-b-uf-hache',
      large:
        'https://res.cloudinary.com/nosrecettes/image/upload/w_1200,h_900,c_fill,q_auto,f_auto/recipes/cari-de-b-uf-hache',
    },
  ],
