...
export const cheesecakeAuChocolat: Recipe = {
  ...
  description:
    'Un cheesecake riche et chocolaté avec une croûte Oreo, une garniture au fromage crémeuse et une ganache au chocolat décorative.',
  categories: ['Desserts'],
  ...
  ingredients: [
    ...
    },
    {
      ...
      items: ['1 1/2 c. pépites de chocolat', '3/4 c. crème épaisse'],
    },
    {
      title: 'Garniture',
      items: ['Copeaux de chocolat'],
    },
  ],
  instructions: [
