...
export const tartareDeSaumonAvocatMangueEtConcombre: Recipe = {
  ...
  description:
    'Un tartare frais et coloré combinant saumon, avocat, mangue et concombre, parfait pour une entrée légère.',
  categories: ['Entrées'],
  ...
  images: [
    {
      small:
        'https://res.cloudinary.com/nosrecettes/image/upload/w_400,h_300,c_fill,q_auto,f_auto/recipes/tartare-de-saumon-avocat-mangue-et-concombre',
      medium:
        'https://res.cloudinary.com/nosrecettes/image/upload/w_800,h_600,c_fill,q_auto,f_auto/recipes/tartare-de-saumon-avocat-mangue-et-concombre',
      large:
        'https://res.cloudinary.com/nosrecettes/image/upload/w_1200,h_900,c_fill,q_auto,f_auto/recipes/tartare-de-saumon-avocat-mangue-et-concombre',
    },
  ],
