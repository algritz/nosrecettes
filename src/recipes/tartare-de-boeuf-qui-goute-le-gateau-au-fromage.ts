...
export const tartareDeBoeufQuiGouteLeGateauAuFromage: Recipe = {
  ...
  instructions: ['Tout mélanger délicatement les ingrédients ensemble.'],
  tags: ['fromage', 'tartare', 'olive'],
  images: [
    {
      small:
        'https://res.cloudinary.com/nosrecettes/image/upload/w_400,h_300,c_fill,q_auto,f_auto/recipes/tartare-de-boeuf-qui-goute-le-gateau-au-fromage',
      medium:
        'https://res.cloudinary.com/nosrecettes/image/upload/w_800,h_600,c_fill,q_auto,f_auto/recipes/tartare-de-boeuf-qui-goute-le-gateau-au-fromage',
      large:
        'https://res.cloudinary.com/nosrecettes/image/upload/w_1200,h_900,c_fill,q_auto,f_auto/recipes/tartare-de-boeuf-qui-goute-le-gateau-au-fromage',
    },
  ],
