...
export const tartareDeConcombreEtHerbes: Recipe = {
  ...
  description:
    "Une salade fraîche de concombre aux fines herbes, servie avec une sauce crémeuse au fromage de chèvre et à l'aneth.",
  categories: ['Salades'],
  ...
  images: [
    {
      small:
        'https://res.cloudinary.com/nosrecettes/image/upload/w_400,h_300,c_fill,q_auto,f_auto/recipes/tartare-de-concombre-et-herbes',
      medium:
        'https://res.cloudinary.com/nosrecettes/image/upload/w_800,h_600,c_fill,q_auto,f_auto/recipes/tartare-de-concombre-et-herbes',
      large:
        'https://res.cloudinary.com/nosrecettes/image/upload/w_1200,h_900,c_fill,q_auto,f_auto/recipes/tartare-de-concombre-et-herbes',
    },
  ],
