...
export const saladeSanteAuxEpinards: Recipe = {
  ...
  description:
    "Salade d'amour avec épinards, champignons, raisins secs, et vinaigrette soja-huile d'olive.",
  categories: ['Salades'],
  ...
  notes:
    'Cette salade ne peut se conserver une fois les épinards mélangés au riz. Afin d’éviter de détremper inutilement les épinards et d’éviter le gaspillage, ne mélanger que les quantités nécessaires et conserver le mélange de riz et d’épinards séparément.',
