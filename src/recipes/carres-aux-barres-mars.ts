...
export const carresAuxBarresMars: Recipe = {
  ...
  description:
    'Recette de carrés chocolatés avec barres Mars, Rice Krispies, chocolat noir et blanc, avec un effet marbré.',
  ...
  images: [
    {
      small:
        'https://res.cloudinary.com/nosrecettes/image/upload/w_400,h_300,c_fill,q_auto,f_auto/recipes/carres-aux-barres-mars',
      medium:
        'https://res.cloudinary.com/nosrecettes/image/upload/w_800,h_600,c_fill,q_auto,f_auto/recipes/carres-aux-barres-mars',
      large:
        'https://res.cloudinary.com/nosrecettes/image/upload/w_1200,h_900,c_fill,q_auto,f_auto/recipes/carres-aux-barres-mars',
    },
  ],
