...
export const saladeDePatateEtKale: Recipe = {
  ...
  description:
    'Une salade fraîche et savoureuse à base de pommes de terre, kale, câpres, et une vinaigrette citronnée.',
  categories: ['Salades'],
  ...
  images: [
    {
      small:
        'https://res.cloudinary.com/nosrecettes/image/upload/w_400,h_300,c_fill,q_auto,f_auto/recipes/salade-de-patate-et-kale',
      medium:
        'https://res.cloudinary.com/nosrecettes/image/upload/w_800,h_600,c_fill,q_auto,f_auto/recipes/salade-de-patate-et-kale',
      large:
        'https://res.cloudinary.com/nosrecettes/image/upload/w_1200,h_900,c_fill,q_auto,f_auto/recipes/salade-de-patate-et-kale',
    },
  ],
