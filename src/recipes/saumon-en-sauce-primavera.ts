...
export const saumonEnSaucePrimavera: Recipe = {
  ...
  description:
    'Un plat de saumon en sauce crémeuse avec légumes, parfumé à la moutarde et au miel.',
  ...
  images: [
    {
      small:
        'https://res.cloudinary.com/nosrecettes/image/upload/w_400,h_300,c_fill,q_auto,f_auto/recipes/saumon-en-sauce-primavera',
      medium:
        'https://res.cloudinary.com/nosrecettes/image/upload/w_800,h_600,c_fill,q_auto,f_auto/recipes/saumon-en-sauce-primavera',
      large:
        'https://res.cloudinary.com/nosrecettes/image/upload/w_1200,h_900,c_fill,q_auto,f_auto/recipes/saumon-en-sauce-primavera',
    },
  ],
