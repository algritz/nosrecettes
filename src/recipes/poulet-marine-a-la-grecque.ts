...
export const pouletMarineALaGrecque: Recipe = {
  ...
  description:
    'Poulet mariné au yogourt grec, citron, ail et origan, cuit au BBQ.',
  ...
  images: [
    {
      small:
        'https://res.cloudinary.com/nosrecettes/image/upload/w_400,h_300,c_fill,q_auto,f_auto/recipes/poulet_marine_a_la_grec',
      medium:
        'https://res.cloudinary.com/nosrecettes/image/upload/w_800,h_600,c_fill,q_auto,f_auto/recipes/poulet_marine_a_la_grec',
      large:
        'https://res.cloudinary.com/nosrecettes/image/upload/w_1200,h_900,c_fill,q_auto,f_auto/recipes/poulet_marine_a_la_grec',
    },
  ],
  accompaniment: 'Sauce Tzatziki et salade grecque',
  source: 'David Cloutier',
  notes:
    'Formaté à partir du contenu fourni; temps et portions variables conservés. [1]',
