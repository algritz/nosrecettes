...
export const chouxDeBruxellesEnSauceAlfredo: Recipe = {
  ...
  description:
    'Recette de choux de Bruxelles en sauce Alfredo avec bacon, crème, citron et parmesan.',
  categories: ['Légumes'],
  ...
  images: [
    {
      small:
        'https://res.cloudinary.com/nosrecettes/image/upload/w_400,h_300,c_fill,q_auto,f_auto/recipes/choux_bruxelle_sauce_alfredo',
      medium:
        'https://res.cloudinary.com/nosrecettes/image/upload/w_800,h_600,c_fill,q_auto,f_auto/recipes/choux_bruxelle_sauce_alfredo',
      large:
        'https://res.cloudinary.com/nosrecettes/image/upload/w_1200,h_900,c_fill,q_auto,f_auto/recipes/choux_bruxelle_sauce_alfredo',
    },
  ],
