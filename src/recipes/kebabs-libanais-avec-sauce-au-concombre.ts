...
export const kebabsLibanaisAvecSauceAuConcombre: Recipe = {
  ...
  description:
    'Recette de kebabs libanais servis avec une sauce au concombre crémeuse, accompagnés de pita, laitue et oignon rouge.',
  ...
  ingredients: [
    ...
    {
      title: 'Pour Servir',
      items: ['Pita', 'Laitue', "Fines tranches d'oignon rouge"],
    },
  ],
  instructions: [
  ...
  notes:
    'Si vous en avez, ajouter 1 c. à thé de sumac au bœuf haché en même temps que les autres assaisonnements pour rehausser le goût.',
