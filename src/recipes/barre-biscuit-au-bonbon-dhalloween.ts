...
export const barreBiscuitAuBonbonDhalloween: Recipe = {
  ...
  description:
    "Une recette de biscuits aux bonbons d'Halloween, croustillants et colorés, parfaits pour la fête.",
  ...
  images: [
    {
      small:
        'https://res.cloudinary.com/nosrecettes/image/upload/w_400,h_300,c_fill,q_auto,f_auto/recipes/barre-biscuit-au-bonbon-d-halloween',
      medium:
        'https://res.cloudinary.com/nosrecettes/image/upload/w_800,h_600,c_fill,q_auto,f_auto/recipes/barre-biscuit-au-bonbon-d-halloween',
      large:
        'https://res.cloudinary.com/nosrecettes/image/upload/w_1200,h_900,c_fill,q_auto,f_auto/recipes/barre-biscuit-au-bonbon-d-halloween',
    },
  ],
