...
export const lasagneTacos: Recipe = {
  ...
  title: 'Lasagne tacos',
  description:
    "Une version fusion entre lasagne et tacos, avec une couche de viande, haricots, maïs, tomates, fromage, et tortillas, cuite au four jusqu'à ce que le fromage soit fondu et doré.",
  ...
  images: [
    {
      small:
        'https://res.cloudinary.com/nosrecettes/image/upload/w_400,h_300,c_fill,q_auto,f_auto/recipes/lasagne-tacos',
      medium:
        'https://res.cloudinary.com/nosrecettes/image/upload/w_800,h_600,c_fill,q_auto,f_auto/recipes/lasagne-tacos',
      large:
        'https://res.cloudinary.com/nosrecettes/image/upload/w_1200,h_900,c_fill,q_auto,f_auto/recipes/lasagne-tacos',
    },
  ],
