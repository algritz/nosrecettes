...
export const tarteletteChocoCaramel: Recipe = {
  ...
  description:
    'Une tartelette gourmande au chocolat et caramel, facile à préparer sans cuisson.',
  ...
  images: [
    {
      small:
        'https://res.cloudinary.com/nosrecettes/image/upload/w_400,h_300,c_fill,q_auto,f_auto/recipes/tartelette-choco-caramel',
      medium:
        'https://res.cloudinary.com/nosrecettes/image/upload/w_800,h_600,c_fill,q_auto,f_auto/recipes/tartelette-choco-caramel',
      large:
        'https://res.cloudinary.com/nosrecettes/image/upload/w_1200,h_900,c_fill,q_auto,f_auto/recipes/tartelette-choco-caramel',
    },
  ],
