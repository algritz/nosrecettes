...
export const patesALaSauceCrue: Recipe = {
  ...
  description:
    'Une recette de pâtes fraîches avec une sauce crue à base de tomates, feta, mozzarella et herbes, idéale pour un dîner léger.',
  ...
  images: [
    {
      small:
        'https://res.cloudinary.com/nosrecettes/image/upload/w_400,h_300,c_fill,q_auto,f_auto/recipes/pates-a-la-sauce-crue',
      medium:
        'https://res.cloudinary.com/nosrecettes/image/upload/w_800,h_600,c_fill,q_auto,f_auto/recipes/pates-a-la-sauce-crue',
      large:
        'https://res.cloudinary.com/nosrecettes/image/upload/w_1200,h_900,c_fill,q_auto,f_auto/recipes/pates-a-la-sauce-crue',
    },
  ],
