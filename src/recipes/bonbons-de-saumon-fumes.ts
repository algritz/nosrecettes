...
export const bonbonsDeSaumonFumes: Recipe = {
  ...
  description:
    "Recette de bonbons de saumon fumés avec marinade, séchage et fumage, badigeonnés de sirop d'érable pour une saveur sucrée-salée.",
  ...
  images: [
    {
      small:
        'https://res.cloudinary.com/nosrecettes/image/upload/w_400,h_300,c_fill,q_auto,f_auto/recipes/bonbon_saumon_fumes',
      medium:
        'https://res.cloudinary.com/nosrecettes/image/upload/w_800,h_600,c_fill,q_auto,f_auto/recipes/bonbon_saumon_fumes',
      large:
        'https://res.cloudinary.com/nosrecettes/image/upload/w_1200,h_900,c_fill,q_auto,f_auto/recipes/bonbon_saumon_fumes',
    },
  ],
  source: 'David Cloutier',
  notes:
    'Temps de marinade de 8 à 12 heures, cuisson de 2 à 4 heures, portions pour 6 à 8 personnes.',
