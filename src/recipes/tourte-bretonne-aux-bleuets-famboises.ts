...
export const tourteBretonneAuxBleuetsFamboises: Recipe = {
  ...
  description:
    "Une délicieuse tourte aux bleuets et framboises, garnie d'un glaçage crémeux, parfaite pour un dessert fruité et gourmand.",
  categories: ['Desserts'],
  ...
  notes:
    'Préparation: 20 à 25 minutes. Cuisson: 50 minutes + 5 minutes. Portions: 8 à 12 personnes. Accompagnement: Excellent avec un coulis de framboise.',
