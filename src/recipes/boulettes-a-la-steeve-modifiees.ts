...
export const boulettesALaSteeveModifiees: Recipe = {
  ...
  description:
    'Recette de boulettes de viande avec sauce sucrée et épicée, cuites au four, accompagnées de pommes de terre pilées.',
  ...
  notes:
    'Temps de préparation : 25 minutes. Temps de cuisson : 1 heure. Source inspirée de recette.qc.ca, modifiée par Fanny Deschamps.',
