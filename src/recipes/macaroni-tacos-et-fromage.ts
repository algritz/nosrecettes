...
export const macaroniTacosEtFromage: Recipe = {
  ...
  notes: 'Note: Excellent souper de semaine. Accompagnement: La prochaine fois je metterai du Tex Mex comme fromage. Je les servirai aussi avec de la coriandre, des oignons vert et de la crème sûre.',
