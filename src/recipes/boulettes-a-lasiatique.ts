...
export const boulettesALasiatique: Recipe = {
  ...
  description:
    "Une recette de boulettes savoureuses à l'influence asiatique, servies avec une sauce épicée et garnies de coriandre et graines de sésame grillées.",
  categories: ['Plats principaux', 'Boeuf', 'Porc'],
  ...
  images: [
    {
      small:
        'https://res.cloudinary.com/nosrecettes/image/upload/w_400,h_300,c_fill,q_auto,f_auto/recipes/boulettes_asiatiques',
      medium:
        'https://res.cloudinary.com/nosrecettes/image/upload/w_800,h_600,c_fill,q_auto,f_auto/recipes/boulettes_asiatiques',
      large:
        'https://res.cloudinary.com/nosrecettes/image/upload/w_1200,h_900,c_fill,q_auto,f_auto/recipes/boulettes_asiatiques',
    },
  ],
  wine: 'Baron de Ley',
  source: 'David Cloutier',
  notes: 'Peut aussi être servi en amuse-gueule.',
  slug: 'boulettes-a-lasiatique',
}
