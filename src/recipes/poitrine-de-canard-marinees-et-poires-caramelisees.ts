...
export const poitrineDeCanardMarineesEtPoiresCaramelisees: Recipe = {
  ...
  ingredients: [
    ...
    '¾ de tasse de bouillon de bœuf (190 ml)',
    '3 à soupe de sauce soya (45 ml)',
    '1 c. à soupe de sauce Worcestershire (15 ml)',
    '1 ½ c. à soupe de sirop d’érable (23 ml)',
    '1 c. à thé de purée d’ail (5 ml)',
  ...
  instructions: [
    ...
    'Mélanger le bouillon de bœuf, la sauce soya, la sauce Worcestershire, le sirop d’érable, la purée d’ail et de gingembre, puis faire mariner les poitrines 2 heures.',
    'Faire chauffer le BBQ.',
    'Retirer les poitrines de la marinade et réserver la marinade.',
    'Faire cuire les poitrines sur la BBQ selon votre technique habituelle.',
    'Faire fondre le beurre à feu vif et y faire dorer les poires.',
    'Une fois dorées, retirer du feu et réserver.',
