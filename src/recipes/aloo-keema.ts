...
export const alooKeema: Recipe = {
  ...
  title: 'Aloo Keema',
  description:
    'Un délicieux plat de keema de veau avec pommes de terre, épices et garniture de coriandre et fenugrec.',
  categories: ['Plats principaux', 'Veau'],
  ...
  images: [
    {
      small:
        'https://res.cloudinary.com/nosrecettes/image/upload/w_400,h_300,c_fill,q_auto,f_auto/recipes/aloo-keema',
      medium:
        'https://res.cloudinary.com/nosrecettes/image/upload/w_800,h_600,c_fill,q_auto,f_auto/recipes/aloo-keema',
      large:
        'https://res.cloudinary.com/nosrecettes/image/upload/w_1200,h_900,c_fill,q_auto,f_auto/recipes/aloo-keema',
    },
  ],
