...
export const trempetteANachos: Recipe = {
  ...
  description:
    'Une trempette savoureuse à base de bœuf, haricots rouges et fromage, parfaite pour accompagner des nachos ou comme apéritif chaud.',
  ...
  images: [
    {
      small:
        'https://res.cloudinary.com/nosrecettes/image/upload/w_400,h_300,c_fill,q_auto,f_auto/recipes/trempette-a-nachos',
      medium:
        'https://res.cloudinary.com/nosrecettes/image/upload/w_800,h_600,c_fill,q_auto,f_auto/recipes/trempette-a-nachos',
      large:
        'https://res.cloudinary.com/nosrecettes/image/upload/w_1200,h_900,c_fill,q_auto,f_auto/recipes/trempette-a-nachos',
    },
  ],
