...
export const browniesAuNutella: Recipe = {
  ...
  description:
    'Délicieux brownies au Nutella avec un glaçage crémeux au Nutella et fromage à la crème.',
  ...
  images: [
    {
      small:
        'https://res.cloudinary.com/nosrecettes/image/upload/w_400,h_300,c_fill,q_auto,f_auto/recipes/brownies-au-nutella',
      medium:
        'https://res.cloudinary.com/nosrecettes/image/upload/w_800,h_600,c_fill,q_auto,f_auto/recipes/brownies-au-nutella',
      large:
        'https://res.cloudinary.com/nosrecettes/image/upload/w_1200,h_900,c_fill,q_auto,f_auto/recipes/brownies-au-nutella',
    },
  ],
