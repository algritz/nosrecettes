...
export const rotiDePorcALaMoutarde: Recipe = {
  ...
  description:
    'Un rôti de porc tendre cuit lentement avec de la moutarde, des échalotes, et une sauce crémeuse.',
  ...
  notes:
    "J'ai décidé de faire cuire à basse température pendant longtemps le rôti pour qu'il soit plus tendre que la version originale.",
