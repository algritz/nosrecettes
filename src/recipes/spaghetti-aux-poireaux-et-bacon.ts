...
export const spaghettiAuxPoireauxEtBacon: Recipe = {
  ...
  images: [
    {
      small:
        'https://res.cloudinary.com/nosrecettes/image/upload/w_400,h_300,c_fill,q_auto,f_auto/recipes/spaghetti_poireaux_et_bacon',
      medium:
        'https://res.cloudinary.com/nosrecettes/image/upload/w_800,h_600,c_fill,q_auto,f_auto/recipes/spaghetti_poireaux_et_bacon',
      large:
        'https://res.cloudinary.com/nosrecettes/image/upload/w_1200,h_900,c_fill,q_auto,f_auto/recipes/spaghetti_poireaux_et_bacon',
    },
  ],
  source: 'David Cloutier',
  notes:
    'La prochaine fois au lieu des œufs pochés, je vais mettre une burrata.',
