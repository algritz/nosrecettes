...
export const linguinesCajunsEtCrevettes: Recipe = {
  ...
  description:
    'Une recette de linguines aux crevettes épicées et sauce crémeuse, facile à préparer en environ 30 minutes.',
  ...
  images: [
    {
      small:
        'https://res.cloudinary.com/nosrecettes/image/upload/w_400,h_300,c_fill,q_auto,f_auto/recipes/linguines-cajuns-et-crevettes',
      medium:
        'https://res.cloudinary.com/nosrecettes/image/upload/w_800,h_600,c_fill,q_auto,f_auto/recipes/linguines-cajuns-et-crevettes',
      large:
        'https://res.cloudinary.com/nosrecettes/image/upload/w_1200,h_900,c_fill,q_auto,f_auto/recipes/linguines-cajuns-et-crevettes',
    },
  ],
