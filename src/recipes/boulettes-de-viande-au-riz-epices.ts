...
export const boulettesDeViandeAuRizEpices: Recipe = {
  ...
  description:
    'Une recette de boulettes de viande épicées avec riz, mijotées dans une sauce tomate, servies avec du pain chaud et croustillant.',
  ...
  images: [
    {
      small:
        'https://res.cloudinary.com/nosrecettes/image/upload/w_400,h_300,c_fill,q_auto,f_auto/recipes/boulettes_viande_riz_epice',
      medium:
        'https://res.cloudinary.com/nosrecettes/image/upload/w_800,h_600,c_fill,q_auto,f_auto/recipes/boulettes_viande_riz_epice',
      large:
        'https://res.cloudinary.com/nosrecettes/image/upload/w_1200,h_900,c_fill,q_auto,f_auto/recipes/boulettes_viande_riz_epice',
    },
  ],
