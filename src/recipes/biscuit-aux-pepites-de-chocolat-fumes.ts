...
export const biscuitAuxPepitesDeChocolatFumes: Recipe = {
  ...
  description:
    'Ces biscuits aux pépites de chocolat fumés sont cuits dans un fumoir pour une saveur unique. Faciles à préparer, ils combinent le goût riche de la mélasse, la douceur du chocolat et le croquant des noix de pécan.',
  ...
  images: [
    {
      small:
        'https://res.cloudinary.com/nosrecettes/image/upload/w_400,h_300,c_fill,q_auto,f_auto/recipes/biscuits_pepite_chocolat_fumes',
      medium:
        'https://res.cloudinary.com/nosrecettes/image/upload/w_800,h_600,c_fill,q_auto,f_auto/recipes/biscuits_pepite_chocolat_fumes',
      large:
        'https://res.cloudinary.com/nosrecettes/image/upload/w_1200,h_900,c_fill,q_auto,f_auto/recipes/biscuits_pepite_chocolat_fumes',
    },
  ],
