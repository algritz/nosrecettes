...
export const tartifletteAuFromageARaclette: Recipe = {
  ...
  images: [
    {
      small: 'https://res.cloudinary.com/nosrecettes/image/upload/w_400,h_300,c_fill,q_auto,f_auto/recipes/tartiflette_fromage_raclette',
      medium: 'https://res.cloudinary.com/nosrecettes/image/upload/w_800,h_600,c_fill,q_auto,f_auto/recipes/tartiflette_fromage_raclette',
      large: 'https://res.cloudinary.com/nosrecettes/image/upload/w_1200,h_900,c_fill,q_auto,f_auto/recipes/tartiflette_fromage_raclette'
    }
  ],
  source: 'David Cloutier',
  notes: 'Formaté à partir du contenu fourni; cuisson totale environ 40 minutes à 400°F [1].',
