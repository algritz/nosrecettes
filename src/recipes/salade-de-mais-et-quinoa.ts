...
export const saladeDeMaisEtQuinoa: Recipe = {
  ...
  description:
    'Une salade fraîche et savoureuse combinant quinoa, maïs, légumes et épices, idéale pour un repas léger ou un accompagnement.',
  categories: ['Salades'],
  ...
  images: [
    {
      small:
        'https://res.cloudinary.com/nosrecettes/image/upload/w_400,h_300,c_fill,q_auto,f_auto/recipes/salade-de-mais-et-quinoa',
      medium:
        'https://res.cloudinary.com/nosrecettes/image/upload/w_800,h_600,c_fill,q_auto,f_auto/recipes/salade-de-mais-et-quinoa',
      large:
        'https://res.cloudinary.com/nosrecettes/image/upload/w_1200,h_900,c_fill,q_auto,f_auto/recipes/salade-de-mais-et-quinoa',
    },
  ],
