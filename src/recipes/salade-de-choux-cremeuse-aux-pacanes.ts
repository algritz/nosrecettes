...
export const saladeDeChouxCremeuseAuxPacanes: Recipe = {
  ...
  description:
    'Excellente dans un sandwich de porc effiloché. Salade de choux crémeuse aux pacanes',
  categories: ['Salades'],
  ...
  images: [
    {
      small:
        'https://res.cloudinary.com/nosrecettes/image/upload/w_400,h_300,c_fill,q_auto,f_auto/recipes/salade-de-choux-cremeuse-aux-pacanes',
      medium:
        'https://res.cloudinary.com/nosrecettes/image/upload/w_800,h_600,c_fill,q_auto,f_auto/recipes/salade-de-choux-cremeuse-aux-pacanes',
      large:
        'https://res.cloudinary.com/nosrecettes/image/upload/w_1200,h_900,c_fill,q_auto,f_auto/recipes/salade-de-choux-cremeuse-aux-pacanes',
    },
  ],
