...
export const saumonGlaceALErableSurPlancheDeCedre: Recipe = {
  ...
  description:
    "Saumon glacé à l'érable cuit sur une planche de cèdre trempée, avec une marinade à la vinaigrette balsamique et sirop d'érable, garni d'oignons rouges.",
  ...
  slug: 'saumon-glace-a-l-erable-sur-planche-de-cedre',
}
