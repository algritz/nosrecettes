...
export const tarteAuVinRougeEtChocolat: Recipe = {
  ...
  description:
    'Une tarte au vin rouge et chocolat avec une croûte croustillante et une garniture riche et lisse, décorée de cool whip et pépites de chocolat.',
  ...
  images: [
    {
      small:
        'https://res.cloudinary.com/nosrecettes/image/upload/w_400,h_300,c_fill,q_auto,f_auto/recipes/tarte-au-vin-rouge-et-chocolat',
      medium:
        'https://res.cloudinary.com/nosrecettes/image/upload/w_800,h_600,c_fill,q_auto,f_auto/recipes/tarte-au-vin-rouge-et-chocolat',
      large:
        'https://res.cloudinary.com/nosrecettes/image/upload/w_1200,h_900,c_fill,q_auto,f_auto/recipes/tarte-au-vin-rouge-et-chocolat',
    },
  ],
