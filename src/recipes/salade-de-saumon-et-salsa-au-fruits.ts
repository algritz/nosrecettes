...
export const saladeDeSaumonEtSalsaAuFruits: Recipe = {
  ...
  description:
    'Une salade fraîche combinant du saumon mariné et une salsa aux fruits colorée.',
  ...
  images: [
    {
      small:
        'https://res.cloudinary.com/nosrecettes/image/upload/w_400,h_300,c_fill,q_auto,f_auto/recipes/salade-de-saumon-et-salsa-au-fruits',
      medium:
        'https://res.cloudinary.com/nosrecettes/image/upload/w_800,h_600,c_fill,q_auto,f_auto/recipes/salade-de-saumon-et-salsa-au-fruits',
      large:
        'https://res.cloudinary.com/nosrecettes/image/upload/w_1200,h_900,c_fill,q_auto,f_auto/recipes/salade-de-saumon-et-salsa-au-fruits',
    },
  ],
