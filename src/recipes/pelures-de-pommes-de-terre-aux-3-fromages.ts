...
export const peluresDePommesDeTerreAux3Fromages: Recipe = {
  ...
  description:
    'Une recette savoureuse de pelures de pommes de terre garnies de trois fromages, parfaites en accompagnement de steaks.',
  ...
  notes:
    'Préparation totale : 50 minutes. Accompagnement recommandé pour steaks.',
