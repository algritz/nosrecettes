...
export const boulettesDePouletAuxOignonsFrancais: Recipe = {
  ...
  description:
    'Une recette de boulettes de poulet parfumées aux oignons caramélisés, servies avec une sauce au bouillon et au thym, garnies de Gruyère fondu.',
  ...
  images: [
    {
      small:
        'https://res.cloudinary.com/nosrecettes/image/upload/w_400,h_300,c_fill,q_auto,f_auto/recipes/boulettes-de-poulet-aux-oignons-francais',
      medium:
        'https://res.cloudinary.com/nosrecettes/image/upload/w_800,h_600,c_fill,q_auto,f_auto/recipes/boulettes-de-poulet-aux-oignons-francais',
      large:
        'https://res.cloudinary.com/nosrecettes/image/upload/w_1200,h_900,c_fill,q_auto,f_auto/recipes/boulettes-de-poulet-aux-oignons-francais',
    },
  ],
