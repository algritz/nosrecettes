...
export const truiteEpicee: Recipe = {
  ...
  title: 'Truite épicée',
  description:
    "Mélanger les épices et faire mariner la truite 20 minutes dans le mélange. Préparer la sauce à l'aneth et citron. Cuire le poisson sur le BBQ. Servir avec du riz et la sauce.",
