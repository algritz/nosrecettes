...
export const saladeDePorcAuxBleuetsEtEpinette: Recipe = {
  ...
  description:
    'Une salade rafraîchissante avec porc mariné dans une vinaigrette aux bleuets et épinette, accompagnée de fruits frais et de salade.',
  categories: ['Salades'],
  ...
  notes:
    "La vinaigrette bleuets & épinette noire n'est pas disponible à l'épicerie. Disponible au marché du Vieux-port de Québec au comptoir de Épicéa.",
