...
export const tarteAuxFraisesSansCuisson: Recipe = {
  ...
  description:
    'Une tarte aux fraises sans cuisson avec une croûte Oreo, une garniture au chocolat et des fraises fraîches, à préparer rapidement et à réfrigérer avant de servir.',
  categories: ['Desserts'],
  ...
  ingredients: [
    {
      title: 'Croûte',
      items: ['32 (330g) biscuits Oreo', '1/2 tasse (110g) de beurre fondu'],
    },
    {
