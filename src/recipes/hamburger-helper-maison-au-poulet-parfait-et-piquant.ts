...
export const hamburgerHelperMaisonAuPouletParfaitEtPiquant: Recipe = {
  ...
  description:
    'One‑pot de pâtes au poulet style buffalo, crémeux et gratiné au cheddar.',
  ...
  images: [
    {
      small:
        'https://res.cloudinary.com/nosrecettes/image/upload/w_400,h_300,c_fill,q_auto,f_auto/recipes/chiken_helper',
      medium:
        'https://res.cloudinary.com/nosrecettes/image/upload/w_800,h_600,c_fill,q_auto,f_auto/recipes/chiken_helper',
      large:
        'https://res.cloudinary.com/nosrecettes/image/upload/w_1200,h_900,c_fill,q_auto,f_auto/recipes/chiken_helper',
    },
  ],
