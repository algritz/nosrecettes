...
export const pouletALOrangeEtAuxArachides: Recipe = {
  ...
  description:
    "Un plat de poulet savoureux avec une sauce à l'orange et aux arachides, parfait pour une cuisson au four et servi avec des quartiers d'orange et des oignons verts.",
