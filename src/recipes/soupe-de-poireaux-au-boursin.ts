...
export const soupeDePoireauxAuBoursin: Recipe = {
  ...
  description:
    'Une soupe onctueuse de poireaux et pommes de terre, enrichie de Boursin ail et fines herbes, garnie de ciboulette.',
  categories: ['Soupes'],
  ...
  images: [
    {
      small:
        'https://res.cloudinary.com/nosrecettes/image/upload/w_400,h_300,c_fill,q_auto,f_auto/recipes/soupe-de-poireaux-au-boursin',
      medium:
        'https://res.cloudinary.com/nosrecettes/image/upload/w_800,h_600,c_fill,q_auto,f_auto/recipes/soupe-de-poireaux-au-boursin',
      large:
        'https://res.cloudinary.com/nosrecettes/image/upload/w_1200,h_900,c_fill,q_auto,f_auto/recipes/soupe-de-poireaux-au-boursin',
    },
  ],
