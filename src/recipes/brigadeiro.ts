...
export const brigadeiro: Recipe = {
  ...
  title: 'Brigadeiro',
  description:
    'Une recette de bonbons brésiliens au chocolat, facile à préparer et idéale pour les fêtes ou comme petite douceur.',
  ...
  images: [
    {
      small:
        'https://res.cloudinary.com/nosrecettes/image/upload/w_400,h_300,c_fill,q_auto,f_auto/recipes/brigadeiro',
      medium:
        'https://res.cloudinary.com/nosrecettes/image/upload/w_800,h_600,c_fill,q_auto,f_auto/recipes/brigadeiro',
      large:
        'https://res.cloudinary.com/nosrecettes/image/upload/w_1200,h_900,c_fill,q_auto,f_auto/recipes/brigadeiro',
    },
  ],
