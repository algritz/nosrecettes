...
export const patesAuxPoireauxEtJambonTresCremeuse: Recipe = {
  ...
  description:
    'Une recette de pâtes crémeuses aux poireaux et jambon, idéale pour utiliser des restes de jambon.',
  ...
  images: [
    {
      small:
        'https://res.cloudinary.com/nosrecettes/image/upload/w_400,h_300,c_fill,q_auto,f_auto/recipes/pates-aux-poireaux-et-jambon-tres-cremeuse',
      medium:
        'https://res.cloudinary.com/nosrecettes/image/upload/w_800,h_600,c_fill,q_auto,f_auto/recipes/pates-aux-poireaux-et-jambon-tres-cremeuse',
      large:
        'https://res.cloudinary.com/nosrecettes/image/upload/w_1200,h_900,c_fill,q_auto,f_auto/recipes/pates-aux-poireaux-et-jambon-tres-cremeuse',
    },
  ],
