...
const Admin = (): React.ReactElement => {
  ...
  const handleGithubConfigSaved = (config: {
    owner: string
    repo: string
    token: string
  }): void => {
    ...
    <div className="container mx-auto px-4 py-8">
      <div className="mb-6">
        ...
        <p className="text-muted-foreground">
          Configurez GitHub pour la gestion des recettes et Cloudinary pour
      ...
      {!isFullyConfigured && (
        <div className="mt-8 p-4 bg-yellow-50 border border-yellow-200 rounded-lg">
          <p className="text-yellow-700 text-sm">
            <strong>Configuration incomplète:</strong> Vous devez configurer à
            la fois GitHub et Cloudinary pour pouvoir ajouter des recettes avec
            images.
          </p>
        </div>
      )}
