...
test.describe('Initial Load & Recipe Display', () => {
  test('should load home page and populate IndexedDB', async ({
    page,
    populatedDb,
  }) => {
  ...
  test('should display recipe cards after load', async ({
    page,
    populatedDb,
  }) => {
  ...
  test('should handle large dataset (720+ recipes)', async ({
    page,
    populatedDb,
  }) => {
  ...
  test('should display recipe card information', async ({
    page,
    populatedDb,
  }) => {
    ...
    const servingsIndicator = firstCard
  ...
  test('should be clickable and navigate to recipe detail', async ({
    page,
    populatedDb,
  }) => {
